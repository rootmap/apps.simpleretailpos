	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12">
	                                    ...
	                                    <div class="input-group" style="margin-top:32px;">
											...
											<a href="javascript:void(0);" data-url="{{url('expense/voucher/excel/report')}}" class="btn btn-info mr-1 change-action">
												<i class="icon-file-excel-o"></i> Generate Excel
											</a>
											<a href="javascript:void(0);" data-url="{{url('expense/voucher/pdf/report')}}" class="btn btn-success mr-1 change-action">
												<i class="icon-file-pdf-o"></i> Generate PDF
											</a>
											<a href="{{url('expense/voucher/report')}}" style="margin-left: 5px;" class="btn btn-danger mr-1">
												<i class="icon-refresh"></i> Reset
											</a>
											<a href="{{url('expense/voucher')}}" class="btn btn-warning mr-1">
