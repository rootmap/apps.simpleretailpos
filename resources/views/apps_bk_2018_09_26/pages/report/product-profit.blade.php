...
<section id="form-action-layouts">
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12">
	                                    ...
	                                    <div class="input-group" style="margin-top:32px;">
											...
											<a href="javascript:void(0);" data-url="{{url('product/profit/excel/report')}}" class="btn btn-info mr-1 change-action">
												<i class="icon-file-excel-o"></i> Generate Excel
											</a>
											<a href="javascript:void(0);" data-url="{{url('product/profit/pdf/report')}}" class="btn btn-success mr-1 change-action">
												<i class="icon-file-pdf-o"></i> Generate PDF
											</a>
											<a href="{{url('product/profit/report')}}" style="margin-left: 5px;" class="btn btn-danger">
	...
	@endif
        ...
        <div class="col-lg-3 col-sm-12 bg-red border-right-pink border-right-lighten-3">
            <div class="card-block text-xs-center">
