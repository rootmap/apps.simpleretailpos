...
<section id="form-action-layouts">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-xs-6 col-sm-3 opdStore" @if($drawerStatus==1) style="display: none;" @endif> 
            <a class="thumbnail btn-block bg-warning"  data-toggle="modal" data-target="#open-drawer" style="line-height: 50px; color: #fff; font-weight: 500; text-align: center;">Open Drawer </a>
        </div>

        <div class="col-md-3 col-xs-6 col-sm-3 cldStore" @if($drawerStatus==0) style="display: none;" @endif> 
            <a class="thumbnail btn-block bg-danger" onclick="loadCloseDrawer()" style="line-height: 50px; color: #fff; font-weight: 500; text-align: center;">Close Drawer </a>
        </div>
     
        <div class="col-md-3 col-xs-6 col-sm-3"> 
            <a class="thumbnail btn-block bg-success" style="line-height: 50px; color: #fff; font-weight: 500; text-align: center;" data-toggle="modal" data-target="#payoutModal">Payout </a>
        </div>
        <div class="col-md-3 col-xs-6 col-sm-3"> 
            <a class="thumbnail btn-block btn-blue btn-lighten-1 btn-block" style="line-height: 50px; color: #fff; font-weight: 500; text-align: center;" data-toggle="modal" data-target="#TimeClockModal">Time Clock </a>
        </div>
        {{-- <div class="col-md-3 col-xs-6 col-sm-3"> 
                    ...
                    <div class="card-text">
                        ...
                        <div class="col-xs-12 button-group">
                            ...
                            <div class="col-xs-4 col-sm-3 col-md-4 col-lg-4 button button1 checkDrawer">
                                <button id="btn-payment-modal_init" type="button" class="btn btn-success btn-responsive btn1" data-toggle="modal" data-target="#payModal">MAKE PAYMENT</button>      
                            </div>  
                            <style type="text/css">
                            ...
                            <div class="col-xs-4 col-sm-3 col-md-4 col-lg-4 button button1 btn-group checkDrawer">
                                ...
                                <button  type="button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-success btn-responsive btn1  dropdown-toggle">PRINT INVOICE &nbsp;</button>      
                            ...
                            <div class="col-xs-4 col-sm-3 col-md-4 col-lg-4 button button6 checkDrawer">
                                <button id="completesale" type="button" class="btn btn-danger btn-responsive btn1">     
                                    COMPLETE SALE
                                </button>
                            </div>
                            ...
                            <div class="col-xs-8 col-sm-6 col-md-8 col-lg-8 button button6">
                                <button id="counterStatusChange" type="button" class="btn btn-warning btn-responsive btn1"> <i class="icon-air-play"></i>  
