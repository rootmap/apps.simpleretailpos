...
?>
		<div class="row">
		<div class="col-md-6 offset-md-3" @if($userguideInit==1) data-step="1" data-intro="You can add a new expense voucher and see to expense voucher report." @endif>
			<div class="card">
					...
					<div class="card-block">
						...
						>
							...
							<div class="form-actions center">
								<a href="{{url('expense/voucher/report')}}" class="btn btn-info mr-1" @if($userguideInit==1) data-step="4" data-intro="If you click this button then it will go to the report page." @endif>
