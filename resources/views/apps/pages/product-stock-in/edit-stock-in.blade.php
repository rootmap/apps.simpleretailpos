...
?>
	...
	<div class="row">
		<div class="col-md-8 offset-md-2" @if($userguideInit==1) data-step="1" data-intro="You are seeing your stockin details and you can change." @endif>
			<div class="card">
	...
	<!-- Both borders end-->
		...
		<div class="row">
			<div class="col-xs-12" @if($userguideInit==1) data-step="2" data-intro="You are seeing your all product stockin inventory items and you can change." @endif>
				<div class="card">
					<div class="card-header">
