...
@section('title','Product Stock IN Order Detail')
@section('content')
<section>
<?php 
...
?>
	...
	<div class="row">
		<div class="col-md-10 offset-md-1" @if($userguideInit==1) data-step="1" data-intro="You are seeing your product stockin details" @endif>
			<div class="card">
				<div class="card-header">
					<h4 align="center" class="card-title" id="from-actions-bottom-right">
						<i class="icon-cloud-upload"></i> Product Stockin Details</h4>
					...
					<div class="card-block">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <h4 align="center">{{$order->order_no}}</h4>
                                </div>
                                <div class="col-md-4">
                                    <h4 align="center">Stockin Order Date. </h4>
                                    <h4 align="center">{{$order->order_date}}</h4>
                                </div>

                                   <div class="col-md-4">
                                    <h4 align="center">Vendor Name </h4>
                                    <h4 align="center">{{$order->vendor_name}}</h4>
                                </div>
	...
	<!-- Both borders end-->
		...
		<div class="row">
			<div class="col-xs-12" @if($userguideInit==1) data-step="2" data-intro="You are seeing your total product stockin inventory item" @endif>
				<div class="card">
					<div class="card-header">
						<h4 class="card-title"><i class="icon-cloud-check"></i> Product Stockin Inventory Item</h4>
						<a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
						<div class="heading-elements">
							<ul class="list-inline mb-0">
