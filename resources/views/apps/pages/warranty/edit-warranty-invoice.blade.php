...
<!-- Both borders end-->
<div class="row">
	<div class="col-xs-12" @if($userguideInit==1) data-step="1" data-intro="You are seeing all the warranty inventory in this table. You can product replace button and back to warranty inventory report button." @endif>
		<div class="card">
						...
						<tfoot>
							...
							<tr>
								<th colspan="5" align="center" style="text-align: center;"> 
									<a href="{{url('warranty/report')}}" class="btn btn-info"  @if($userguideInit==1) data-step="2" data-intro="Please click here for back to warranty inventory report page." @endif>
