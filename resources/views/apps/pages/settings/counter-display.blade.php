...
?>
	...
	<!-- Both borders end-->
<div class="row">
	<div class="col-xs-12" @if($userguideInit==1) data-step="4" data-intro="You are seeing all counter display list. You can edit/delete any counter display info." @endif>
		<div class="card">
			<div class="card-header">
						...
						<tbody>
							...
							<tr>
								...
								<td>
                                        ...
                                        <a href="{{url('counter/display/add/edit/'.$row->id)}}" title="Edit" class="btn btn-sm btn-outline-info" @if($userguideInit==1) data-step="5" data-intro="If you want you can modify your information when you click this button." @endif><i class="icon-pencil22"></i></a>
                                        @endif
                                        @if(in_array('Counter_Display_Info_List_Delete', $dataMenuAssigned)) 
                                        <a  href="{{url('counter/display/add/delete/'.$row->id)}}" title="Delete" class="btn btn-sm btn-outline-info btn-darken-2" @if($userguideInit==1) data-step="6" data-intro="If you want delect then click this button." @endif><i class="icon-cross"></i></a>
                                        @endif
