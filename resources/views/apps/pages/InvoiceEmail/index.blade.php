...
@section('content')
   <?php 
    ...
    //dd($dataMenuAssigned);
?>
            <div class="col-md-12" @if($userguideInit==1) data-step="1" data-intro="You can edit email invoice info and set send email time and enable receipt BCC." @endif>
        ...
        <div class="col-md-12"  @if($userguideInit==1) data-step="2" data-intro="You are seeing your product invoice information." @endif
