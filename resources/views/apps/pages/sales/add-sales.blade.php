...
@section('title','Product For Sale')
@section('content')
...
?>
	...
	<div class="row">
		<div class="col-md-6 offset-md-3" @if($userguideInit==1) data-step="1" data-intro="You create product for sales." @endif>
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="from-actions-bottom-right"><i class="icon-cart31"></i> Add Product For Sale 
						{{-- <a href="{{url('pos')}}" class="btn btn-primary">Switch Sales View </a> --}}
					</h4>
	...
	<!-- Both borders end-->
	<form class="form" action="{{url('sales/confirm')}}" method="post">
		{{ csrf_field() }}
		<div class="row">
			<div class="col-xs-12" @if($userguideInit==1) data-step="2" data-intro="You see your added product in shopping cart and click proceed button." @endif>
				<div class="card">
					<div class="card-header">
