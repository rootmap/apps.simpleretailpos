...
<section id="file-exporaat">
	...
	<!-- Both borders end-->
<div class="row">
	<div class="col-xs-12" @if($userguideInit==1) data-step="4" data-intro="You are seeing all customer in this table. You can edit and delete in this table" @endif>
		<div class="card">
			<div class="card-header">
					...
					<table class="table table-striped table-bordered zero-configuration">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{$row->email}}</td>
								<td>
                                        <a href="{{url('customer/edit/'.$row->id)}}" title="Edit" class="btn btn-sm btn-outline-info" @if($userguideInit==1) data-step="5" data-intro="If you want you can modify your information when you click this button." @endif><i class="icon-pencil22"></i></a>
                                        <a  href="{{url('customer/delete/'.$row->id)}}" title="Delete" class="btn btn-sm btn-outline-info btn-darken-1"  @if($userguideInit==1) data-step="6" data-intro="If you want delect customer then click this button." @endif><i class="icon-cross"></i></a>
								</td>
							</tr>
							@endforeach
							@else
