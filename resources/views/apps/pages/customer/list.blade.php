					...
					<table class="table table-striped table-bordered zero-configuration">
						...
						<tbody>
							...
							<tr>
								...
								@if(in_array('list_customer_report', $dataMenuAssigned))
								<td>
									<a href="{{url('customer/report/'.$row->id)}}" class="btn btn-info mr-1 change-action" @if($userguideInit==1) data-step="2" data-intro="When you see report then click view report button." @endif>
