        ...
        <div class="modal-body">
          ...
          <div class="modal-footer">
            ...
            <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5 button button1 authorizenet btn-group">
              @if(isset($authorizeNettender))
              <a id="btn-payment-modal_modal_button" data-id="{{$authorizeNettender[0]->id}}" type="button" class="btn btn-info btn-lighten-1 btn-responsive margin-all-bottom-button manualcardPayment" >
            ...
            <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 button button1 authorizenet btn-group">
              ...
              <a id="btn-payment-modal_modal_button" data-id="{{$payPaltender[0]->id}}" type="button" class="btn btn-info btn-lighten-2 btn-responsive margin-all-bottom-button manualPaypalPayment" >
                {{$payPaltender[0]->name}}
              </a>
              @endif
            </div>
